...
const TokenInput = dynamic(
    () =>
        import("@/components/token-input").then((mod) => ({
            default: mod.TokenInput,
        })),
    {
    ...
    const faqs = [
        {
            ...
            answer: "Yes. CloudSaver only uses read-only API tokens, which means it cannot modify, delete, or create resources in your DigitalOcean account. Additionally, tokens are not stored permanently—they're used once and immediately discarded after analysis.",
        },
        {
            question: "How long does an analysis take?",
            answer: "Typically less than 30 seconds for accounts with up to 100 resources. The time may vary depending on the number of resources you have. CloudSaver analyzes historical metrics to generate more accurate recommendations.",
        },
        {
            question: "How much can I save?",
            answer: "It depends on your current infrastructure. Users typically find savings opportunities of 10-40% of their monthly cost. CloudSaver will show you exactly how much you can save after analyzing your account.",
        },
        {
            question: "Does CloudSaver modify my resources automatically?",
            answer: "No. CloudSaver only provides recommendations. You decide what to implement and when. CloudSaver provides you with the information and commands needed, but you have complete control.",
        },
        {
            question: "Do I need advanced technical knowledge?",
            answer: "No. CloudSaver is designed to be used by anyone who has a DigitalOcean account. Recommendations are clear and understandable, and if you need help with implementation, CloudSaver provides exact commands that you can copy and paste.",
        },
        {
            question: "Is CloudSaver really free?",
            answer: "Yes, CloudSaver is completely free. There are no hidden fees, no credit card required, and no subscription. You can analyze your DigitalOcean infrastructure as many times as you want at no cost.",
        },
    ];
